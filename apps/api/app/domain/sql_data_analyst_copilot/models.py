...
class AgenticSqlDataAnalystCopilotSession(Base):
    __tablename__ = "sql_data_analyst_copilot_sessions"
...
class AgenticSqlDataAnalystCopilotItem(Base):
    __tablename__ = "sql_data_analyst_copilot_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("sql_data_analyst_copilot_sessions.id"))
